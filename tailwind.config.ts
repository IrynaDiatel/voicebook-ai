  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-hero": "linear-gradient(135deg, #0f0f1a 0%, #1e1b4b 50%, #2e1065 100%)",
        "gradient-card": "linear-gradient(145deg, rgba(79,70,229,0.05) 0%, rgba(124,58,237,0.05) 100%)",
      ...
      boxShadow: {
        "brand": "0 4px 24px rgba(79,70,229,0.25)",
        "brand-lg": "0 8px 40px rgba(79,70,229,0.35)",
        "brand-xl": "0 16px 60px rgba(79,70,229,0.45)",
        ...
        "glass": "0 8px 32px rgba(79,70,229,0.1), inset 0 1px 0 rgba(255,255,255,0.1)",
      },
      backdropBlur: {
        xs: "2px",
      },
